pipeline {
    ...
    environment {
        PROJECT_NAME = "seCommerce-project-Using-REACT-JS"
        DOCKERHUB_USERNAME = "madhav7022"
        DOCKERHUB_REPO = "flipkart"
    ...
    post {
        success {
            echo "Flipkart CI/CD pipeline executed successfully!"
        }
        failure {
            echo "Flipkart CI/CD pipeline failed!"
        }
        always {
